#============================================================================
# calc_cloud_properties_varying_Zemin_Dmin_function.py
# Calculates cloud properties from merged ceilometer, radar,
# and sounding datasets and saves to dictionary.
# 
# Function 'calc_cloud_properties' includes the follow
# required arguments:
...
#===================================================
#===================================================
def calc_cloud_properties(infile,date,dmin,ze_thresh,**kwargs):
