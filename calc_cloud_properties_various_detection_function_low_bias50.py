...
# but low-biasing the CBH by 50 m (2 BASTA range gates).
#
...
#===================================================
#===================================================
def calc_cloud_properties_low_bias50(infile,date,dmin,ze_thresh,**kwargs):
    ...
    for tt in range(num_times):
        ...
        #-------------------------------------------------  
            ...
            single_time_cbh = single_time_cbh - 50.
            #print(single_time_cbh)
            #print(aaaa)
